...
const sco = '/assets/sco.png';;
const Engagement = '/assets/Engagement.png';;
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start gap-16">
        ...
        >
          <Image src={sco} width={600} height={600} className="rounded-[2.5rem] w-full h-auto object-cover" alt="SEO Analysis" />
        </motion.div>
      </div>
    </section>
  );
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row-reverse items-center lg:items-start gap-16">
        ...
        <div className="lg:w-1/2 lg:sticky lg:top-24">
          <div className="max-w-[420px] mr-auto -mt-12 overflow-hidden">
            <Image src={Engagement} width={500} height={500} className="w-full h-auto object-cover" alt="Social App Mockup" />
          </div>
        </div>
      </div>
    </section>
