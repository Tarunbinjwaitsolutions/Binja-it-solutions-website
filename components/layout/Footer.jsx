        ...
        <footer className="text-sm py-4 transition-colors duration-300" style={{ backgroundColor: "var(--footer-bg)", borderTop: "var(--footer-border)" }}>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-row lg:justify-between gap-8 lg:gap-6 xl:gap-8 items-start mb-10 w-full">
                    ...
                    {/* Services */}
                    <motion.div variants={fadeInUp} className="lg:w-auto">
                    ...
                    <motion.div variants={fadeInUp} className="md:col-span-2 lg:w-auto flex flex-col xl:flex-row gap-5 xl:gap-5 items-start">
                        ...
                        <div className="flex flex-col space-y-6 w-full xl:flex-1 text-xs">
                            ...
                            <div className="flex items-start text-xs gap-4">
                                ...
                                <div className="flex flex-col space-y-1 text-xs">
                                    ...
                                    <span style={{ color: "var(--footer-text)" }}>+91 79741 47736</span>
                                </div>
                            </div>
                        </div>
                ...
                <motion.div variants={fadeInUp} className="border-t pt-4 pb-2 text-center" style={{ borderColor: "rgba(255,255,255,0.1)" }}>
                    ...
                    {/* <p className="text-[10px] leading-relaxed max-w-4xl mx-auto" style={{ color: "var(--footer-muted)" }}>
                        Binjwa IT Solutions is a leading technology company specializing in AI automation, web development, CRM solutions, mobile app development, ERP systems, cloud solutions, and digital transformation services. We help businesses across India and globally leverage innovative technology to improve efficiency, drive growth, and stay competitive in the digital era.
                    </p> */}
                </motion.div>
            </motion.div>
        </footer>
