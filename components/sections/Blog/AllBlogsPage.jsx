          ...
          <>
            ...
            <div className="flex items-center justify-center gap-2 mt-20">
              ...
              <div className="flex items-center gap-1 mx-2 text-sm font-bold">
                {Array.from({ length: totalPages }, (_, index) => {
                  ...
                  if (pageNum === 2 || pageNum === totalPages - 1) {
                    return (
                      <span key={pageNum} className="px-2 text-neutral-300">
                        ...
                      </span>
                    );
                  }
              ...
              <button
                ...
                className={`p-2.5 rounded-xl border border-neutral-200 transition-all ${
                  currentPage === totalPages
                    ? "bg-neutral-100 text-neutral-300 cursor-not-allowed"
                    : "bg-white text-neutral-700 hover:bg-neutral-50 hover:border-neutral-300"
                }`}
              >
