...
export default function VoiceBotWidget() {
  ...
  function triggerGreeting() {
    ...
    const context = {
      ...
      bodyText: (document.body ? document.body.innerText : "").substring(
        0,
        3000,
      ),
    };
  ...
  function handleLanguageChange(e) {
    ...
    if (wsRef.current && wsRef.current.readyState === WebSocket.OPEN) {
      ...
      setMessages([]);
      stopAudio();
      wsRef.current.send(JSON.stringify({ type: "open", lang: newLang }));
    }
  }
            ...
            <div className="bg-[#6c63ff] px-4 py-3 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span
                      className={`w-2 h-2 rounded-full inline-block ${status === "idle" || status === "speaking" || status === "listening" ? "bg-orange-400" : "bg-orange-400"}`}
                    />
              ...
              <div className="flex items-center gap-2">
                {/* <select 
                  ...
                  className="bg-white/10 text-white text-xs py-1 px-2 rounded-md outline-none border border-white/20 hover:bg-white/20 transition-colors"
                >
