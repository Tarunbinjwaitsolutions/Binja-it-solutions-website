...
const Banner = ({ showBanner, handleCloseBanner, bannerImageUrl }) => {
  ...
  return (
    <div className="fixed top-0  left-0 w-full h-full bg-opacity-50 flex justify-center items-center z-[1000]">
      <div className="relative rounded-r-2xl md:rounded-3xl overflow-hidden">
        <X
          className="absolute top-3.5 right-3.5 text-2xl p-1 bg-neutral-200/30 rounded-full text-center border-none text cursor-pointer"
