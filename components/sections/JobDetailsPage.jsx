...
const JobDetailsPage = () => {
  ...
  if (!job) {
    return (
      <div className="min-h-screen bg-transparent flex items-center justify-center" style={{ backgroundColor: "var(--bg-secondary)" }}>
  ...
  return (
    <div className="min-h-screen bg-transparent font-sans pt-24" style={{ backgroundColor: "var(--bg-secondary)" }}>
        ...
        >
          <header className="rounded-2xl shadow-lg p-8 mb-10 transition-colors duration-300" style={{ backgroundColor: "var(--bg-primary)" }}>
            ...
            <div className="mt-6 pt-6 border-t flex flex-wrap gap-x-8 gap-y-4" style={{ borderColor: "var(--border)", color: "var(--text-muted)" }}>
              ...
              <div className="flex items-center">
                <Briefcase size={18} className="mr-2 text-neutral-400" />
                <span>{job.details.type}</span>
              </div>
              <div className="flex items-center">
                <Clock size={18} className="mr-2 text-neutral-400" />
        ...
        >
          <div className="lg:col-span-2">
            <motion.div
              ...
              className="rounded-2xl shadow-lg p-8 transition-colors duration-300" style={{ backgroundColor: "var(--bg-primary)" }}
            >
          ...
          <div className="space-y-8">
            <motion.div
              variants={itemVariants}
              className="rounded-2xl shadow-lg p-6 transition-colors duration-300" style={{ backgroundColor: "var(--bg-primary)" }}
            >
