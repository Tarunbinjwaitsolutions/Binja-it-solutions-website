...
import { CheckCircle2, ChevronDown, Image as ImageIcon, Smile, MapPin, Send, ArrowUpRight, ArrowDownRight, Bell, Users, BarChart2, MessageSquare } from "lucide-react";
...
export function LandingFeatures() {
  ...
  return (
    <section id="features" className="bg-[#09090B] relative pt-24">
      <div className="max-w-7xl mx-auto px-6 mb-5 text-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 lg:sticky lg:top-24 lg:h-[calc(100vh-6rem)] lg:self-start flex items-center justify-center py-12 lg:py-0 pr-0 lg:pr-12">
            <div
              key={activeIndex}
...
// --- Layout Wrapper ---
const LaptopFrame = ({ children, badgeText }) => (
